...
var (
	...
	BenchFlag       = flag.String("bench", "", `Enable benchmark`)
)
...
func Env() Environment {
	...
	case os.Getenv("CI") == "true" && os.Getenv("TRAVIS") == "true":
		return Environment{
			...
			BenchMark:     os.Getenv("TRAVIS_BENCH"),
		}
	case os.Getenv("CI") == "True" && os.Getenv("APPVEYOR") == "True":
		return Environment{
			...
			BenchMark:     os.Getenv("APPVEYOR_BENCH"),
		}
	default:
		return LocalEnv()
	}
...
func LocalEnv() Environment {
	env := applyEnvFlags(Environment{Name: "local", Repo: "skyhark/golang"})
